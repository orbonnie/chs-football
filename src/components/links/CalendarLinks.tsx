  ...
  return (
    <div className="flex gap-2 ml-auto">
      <a
        ...
        className={`flex-1 flex items-center justify-center gap-1.5 font-display tracking-widest uppercase text-xs ${shrink ? "px-1.5 sm:px-3" : "px-3"} py-1.5 rounded-lg border border-royal-600/30 transition-colors ${
