      ...
      {days.map(({ day, dateKey, events }) => {
        ...
        return (
          ...
          >
            {/* Date column */}
            <div
              className={`w-20 shrink-0 px-4 py-4 flex flex-col items-center justify-start bg-${altBg} border-r border-gray-100 ${isToday ? "bg-royal-600/5" : ""}`}
            >
              <p className="font-display text-xs tracking-widest uppercase text-gray-400">
                {date.toLocaleDateString("en-US", { weekday: "short" })}
              </p>
              <div
                className={`w-8 h-8 flex items-center justify-center rounded-full font-display text-sm mt-0.5 ${isToday ? "bg-royal-600 text-white" : "text-gray-700"}`}
              >
                {day}
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <div ref={calendarFilterRef} className="relative">
                ...
                >
                  ...
                  <svg
                    className={`w-3 h-3 transition-transform ${calendarOpen ? "rotate-180" : ""}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                {calendarOpen && (
                  <div className="absolute right-0 top-full mt-2 min-w-42 w-max bg-white shadow-xl rounded-xl overflow-visible z-50">
                    {CALENDARS.map((cal) => {
                      ...
                      return (
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-2 sm:gap-3 px-4 py-3 hover:bg-gray-50 transition-colors"
                        >
                          <div
              ...
              <div ref={viewRef} className="relative">
                ...
                >
                  {view}
                  <svg
                    className={`w-3 h-3 transition-transform ${viewOpen ? "rotate-180" : ""}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="shrink-0 p-1.5 pb-0">
                      <div
                        className={`w-3 h-3 sm:w-7 sm:h-7 flex items-center justify-center rounded-full text-sm font-display mb-1 ${isToday ? "bg-royal-600 text-white" : "text-gray-700"}`}
                      >
                        {day}
                      </div>
                    </div>
