...
const colGrid = "grid grid-cols-[8rem_minmax(0,20rem)_14rem_5rem_5rem_4rem] items-center"

function ColumnHeaders() {
  return (
    <div className={`hidden md:grid ${colGrid} px-6 py-2 border-b border-gray-200 text-gray-500 bg-gray-50 font-display text-xs tracking-widest uppercase `}>
      <span className="font-display text-xs tracking-widest uppercase text-left">Date</span>
      <span>Opponent</span>
...
function VarsityRow({ game }: { game: Game }) {
  ...
  return (
    <div className="px-6 py-4 border-b border-gray-300 last:border-0">
      {/* Mobile */}
...
const jvColGrid = "grid grid-cols-[4rem_1fr_4rem_4rem_2rem] items-center gap-x-4"

function JVRow({ game }: { game: Game }) {
  const isBye = game.location === 'BYE'
  const textColor = gameTextColor(game.location)
  return (
    <div className={`${jvColGrid} px-4 py-3 border-b border-gray-100 last:border-0`}>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-silver-00 rounded-2xl overflow-hidden mb-14">
          ...
          <div className="bg-black-500 px-6 py-5 flex items-end justify-between">
            ...
            <div className="flex items-center gap-6 pb-1">
              <span className="font-display text-royal-400 text-sm tracking-widest">HOME</span>
              <span className="text-white/70">/</span>
              <span className="bg-white px-1 rounded-lg">
                <span className="font-display text-black-500 text-sm tracking-widest">AWAY</span>
              </span>
              <span className="text-white/70">/</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-silver-300 rounded-2xl overflow-hidden pb-5 mb-8">
            ...
            {freshman.map((game, i) => <JVRow key={i} game={game} />)}
          </div>
